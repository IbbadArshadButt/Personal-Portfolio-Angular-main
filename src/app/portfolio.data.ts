...
export const PROJECTS: Project[] = [
  {
    ...
    icon: 'bi-grid-1x2',
    description:
      'A real-time analytics dashboard with modular widgets, role-based access, and live data analytics for movies orders, purchases and listings.',
    stack: ['Angular', '.NET', '.NET Web Forms','AJAX', 'SQL Server'],
    github: 'https://github.com/IbbadArshadButt/Movies-Platform',
    demo: '#',
  },
  {
    ...
    icon: 'bi-grid-1x2',
    description:
      'A real-time analytics dashboard for admin, role-based access, and seamless experience for users, agents, and property owners.',
    stack: ['MERN', 'React','NodeJS', 'MongoDB', 'JWT'],
    github: 'https://github.com/IbbadArshadButt/RealEstateFYP',
    demo: 'https://realestatefyp.onrender.com/',
  },
  {
    ...
    icon: 'bi-palette',
    description:
      'Single-page application that allows users to upload, apply image processing effects (blur, sharpen, add watermark), and download their images.',
    stack: ['HTML', 'Bootstrap', 'JavaScript', 'CSS'],
    github: 'https://github.com/IbbadArshadButt/Image-Essence',
    demo: 'https://image-essence.netlify.app/',
  },
  {
    ...
    icon: 'bi-list-check',
    description:
      'A collaborative task manager built using Angular for organizing daily tasks efficiently.',
    stack: ['Angular', 'Bootstrap', 'TypeScript'],
    github: 'https://github.com/IbbadArshadButt/task-management-angular',
    demo: '#',
  },
  {
    ...
    description:
      'Railway Reservation System frontend using HTML, CSS, and JavaScript with some basic features like Login & Register interfaces.',
    stack: ['HTML', 'Bootstrap', 'JavaScript', 'CSS'],
